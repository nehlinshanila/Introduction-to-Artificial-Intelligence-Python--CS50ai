...
class Maze():
    ...
    def solve(self):
        """Finds a solution for the maze if one exists"""
        
        # Keep track of the number of explored nodes
        self.num_explored = 0
        
        # Initialize the frontier with just the starting position
        ...
        while True:
            ...
            if node.state == self.goal:
                ...
                # Follow parent nodes to find the solution path
